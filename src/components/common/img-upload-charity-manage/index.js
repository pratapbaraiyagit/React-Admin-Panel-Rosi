...
const ImgUploadCharityManage = ({ multiple, setImages, images, setapiImageName, isEdit,oldImages, setOldImages: setOldCauseImages, setDeleteImage, setImg, moduleName }) => {
                        ...
                        <div className='img-map-box'>
                            {oldImages?.length > 0 && multiple ? oldImages?.map((image, index) => (
                                <div key={index} imageListlassName="image-item">
                                    <img src={mediaURL + "charityLogo/" + image} alt="Image" width="100" />
                            ...
                            {oldImages?.length && !multiple && imageList.length === 0 ? oldImages?.map((image, index) => (
                                image && <div key={index} className="image-item">
                                    <img src={mediaURL+"charityLogo/"+image} alt="777" width="100" />
                                    <div className="image-item__btn-wrapper">
...
export default ImgUploadCharityManage
