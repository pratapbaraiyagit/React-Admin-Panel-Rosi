...
const Chome = () => {
    ...
    const list = [
        ...
        {
            name:"Homepage",
            link: " content_management / homepage ",
            isactive:true
        }
      ]
                                ...
                                <form onSubmit={handleSubmit} >
                                    <div className='input-list d-flex flex-wrap' >
                                        ...
                                        <div className='col-md-6 col-div'>
                                            <label className='label-text'> <span>*</span> Banner Image </label>
                                            <ImgUpload
                                                moduleName='homepage'
                                                multiple={false}
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> Banner title</label>
                                            <Field
                                                name="bannertitle"
                                                type="text"
                                                placeholder="Banner title"
                                                component={renderField}
                                                // validate={ (value) => required(value,('Banner title'))}
                                                className="form-grp"
                                                inputclass="input-box"
                                            />
                                        </div>
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> Banner description</label>
                                            <Field
                                                name="bannerdescription"
                                                type="text"
                                                placeholder="Banner description"
                                                component={rendertextarea}
                                                // validate={ (value) => required(value,('Banner description'))}
                                                className="form-grp"
                                        ...
                                        <div className='col-md-6 col-div'>
                                            <label className='label-text'> <span>*</span> About heading</label>
                                            <Field
                                                name="aboutheading"
                                                type="text"
                                                placeholder="About heading"
                                                component={renderField}
                                                // validate={ (value) => required(value,('About heading'))}
                                                className="form-grp"
                                                inputclass="input-box"
                                            />
                                        </div>
