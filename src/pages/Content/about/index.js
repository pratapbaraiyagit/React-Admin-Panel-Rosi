...
const About = () => {
    ...
    const list = [
        ...
        {
            name:"About Us",
            link: " content_management / about_us",
            isactive:true
        }
      ]
                                ...
                                <form onSubmit={handleSubmit} >
                                    <div className='input-list d-flex flex-wrap' >
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About Image </label>
                                            <ImgUpload
                                                moduleName='homepage'
                                                multiple={false}
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About title</label>
                                            <Field
                                                name="Abouttitle"
                                                type="text"
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About description</label>
                                            <Field
                                        ...
                                        <div className='col-12 col-div'>
                                            <h4 className="matter-h4">Why We matter</h4>
                                        </div>
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About Image - 1 </label>
                                            <ImgUpload
                                                moduleName='homepage'
                                                multiple={false}
                                                oldLogo={metaData?.mediaURL+ 'homepage/'+ homepagedetail.logo}
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About title - 1</label>
                                            <Field
                                                name="abouttitle"
                                                type="text"
                                                placeholder="About title"
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About description - 1</label>
                                            <Field
                                                name="aboutdescription"
                                                type="text"
                                                placeholder="About description"
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About Image - 2 </label>
                                            <ImgUpload
                                                moduleName='homepage'
                                                multiple={false}
                                                oldLogo={metaData?.mediaURL+ 'homepage/'+ homepagedetail.logo}
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About title - 2</label>
                                            <Field
                                                name="abouttitle"
                                                type="text"
                                                placeholder="About title"
                                        ...
                                        <div className='col-12 col-div'>
                                            <label className='label-text'> <span>*</span> About description - 2</label>
                                            <Field
                                                name="aboutdescription"
                                                type="text"
                                                placeholder="About description"
                                        ...
                                        <div className='col-12 col-div'>
                                            <h4 className="matter-h4">Manage Leadership</h4>
                                            <Link to="/content_management/about_us/add_leadership" className='link-btn leadership-btn'> Add Leadership </Link>
                                        </div>
                                        {/* {
                                            listitems.map( (i) => (
                                                <>
                                    ...
                                    <div className='d-flex flex-wrap form-btn-box' >
                                        ...
                                        <Link to='/dashboard' className='link-btn cancel'>Cancel</Link>
                                    </div>
                                </form>
